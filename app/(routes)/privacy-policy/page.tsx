export default function PrivacyPolicy() {
  return (
    <>
      <main className="max-w-screen-lg mx-auto px-2 lg:px-0 py-10">
        <h1 className="text-4xl md:text-[42px] font-bold ">Privacy Policy</h1>

        <p className="py-3">
          <strong>Effective Date: 23-01-2024</strong>
        </p>
        ...
        <h2 id="tableofcontents" className="text-2xl md:text-3xl font-bold my-3 ">Contents</h2>
        <p>Click below to jump to any section of this privacy policy</p>
        <ol type="1" className="list-decimal list-inside mx-10 my-4">
          <li>
            <a href="#PII">
        ...
        <p className="mb-2">
          ...
          comment at https://notex-next.vercel.app to provide a username and
          email address.
        </p>

        <p>
          <a href="#tableofcontents" className="font-semibold">Back to table of contents</a>
        </p>
        <h2 id="Security" className="text-2xl md:text-3xl font-bold my-3">2. Security</h2>
        <p className="mb-2">
        ...
        <h2 id="Credit" className="text-2xl md:text-3xl font-bold my-3">5. Contact Information &amp; Credit</h2>
        <p className="mb-2">
          ...
          us via <a href="mailto:iamsoumo2004@gmail.com">email</a> or{" "}
          <a href="tel:">phone</a>.
        </p>

        <p>
          <a href="#tableofcontents" className="font-semibold mt-2">Back to table of contents</a>
        </p>
      </main>
    </>
  );
